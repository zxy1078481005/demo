...
var Footer = {
  init: function(){
    ...
    this.$leftBtn = this.$footer.find('.icon-before')
    this.$rightBtn = this.$footer.find('.icon-later')
    this.isToEnd = false
    this.isToStart = true
  ...
  setStyle: function(){
    var count = this.$footer.find('li').lenght
...
var Fm = {
  ...
  loadMusic(callback){
    ...
    $.get('http://api.jirengu.com/fm/getSong.php',{channel:this.channelId})
     .done(function(ret){
